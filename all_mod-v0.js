...
در این صورت فایل را دوباره دانلود و با گزینه‌ی باز کردن با ماینکرفت وارد کنید.` },
    'Resource-Pack': { title: "آموزش نصب تکسچر/ریسورس پک", pic: "images/guide-p.png", text: `🟦 - آموزش کامل دانلود و نصب تکسچر پک
برای دانلود یک تکسچر پک، ابتدا وارد بخش تکسچر پک‌ها شوید و تکسچر پک موردنظر خود را انتخاب کنید.
بعد از اطمینان از سازگاری تکسچر پک با نسخه‌ی Minecraft خود، روی دانلود فایل بزنید.
صبر کنید تا دانلود کاملاً تمام شود. پس از پایان دانلود، دکمه‌ی باز کردن با ماینکرفت نمایش داده می‌شود.
روی این دکمه بزنید تا فایل مستقیماً به Minecraft ارسال شود.
🎮 داخل Minecraft چه کاری انجام دهیم؟
پس از باز شدن Minecraft، بازی شروع به Import کردن فایل می‌کند.
در این مرحله هیچ کاری انجام ندهید و صبر کنید تا عملیات به پایان برسد.
اگر Import با موفقیت انجام شود، معمولاً پیامی مبنی بر موفقیت‌آمیز بودن وارد کردن فایل نمایش داده می‌شود.
حالا برای فعال کردن تکسچر پک:
وارد Play شوید.
یک دنیای جدید بسازید یا تنظیمات یک دنیای موجود را باز کنید.
وارد بخش Resource Packs شوید.
تکسچر پک واردشده را پیدا کنید.
روی آن بزنید تا فعال شود.
پس از فعال شدن تکسچر پک، وارد دنیا شوید.
حالا تغییرات ظاهری تکسچر پک باید در بازی اعمال شده باشد.
⚠️ اگر تکسچر پک Import شد ولی در بازی کار نکرد
اگر Import با موفقیت انجام شد اما ظاهر بازی تغییر نکرد، ابتدا بررسی کنید که تکسچر پک را از بخش Resource Packs فعال کرده باشید.
همچنین مطمئن شوید تکسچر پک در قسمت بسته‌های Active قرار گرفته باشد.
اگر چند تکسچر پک همزمان فعال هستند، ممکن است یکی از آن‌ها روی دیگری تأثیر بگذارد.
در نهایت، سازگاری تکسچر پک با نسخه‌ی Minecraft خود را بررسی کنید.` },
